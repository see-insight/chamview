...
class TkinterGui(Chooser):
    ...
    def createGui(self):
        ...
        self.canvas = Canvas(self.frameR,width=TkinterGui.canvas_width,
            height=TkinterGui.canvas_height)
    ...
    def updatePhoto(self):
        ...
        scaleX = float(TkinterGui.canvas_width)/width
        scaleY = float(TkinterGui.canvas_height)/height
